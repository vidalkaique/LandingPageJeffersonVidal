-- ============================================
-- SCRIPT PARA CONFIGURAR HORÁRIOS NO SUPABASE
-- ============================================
...
-- 4. Política para leitura pública (todos podem ver horários)
CREATE POLICY "Horários são públicos para leitura" ON public.horarios
  FOR SELECT USING (true);

-- 5. Política para escrita apenas com chave de API (Jefferson)
CREATE POLICY "Apenas admin pode modificar horários" ON public.horarios
  FOR ALL USING (
    auth.jwt() ->> 'role' = 'service_role' OR
    auth.jwt() ->> 'email' = 'jefferson@personaltrainer.com'
  );

-- 6. Inserir dados iniciais (horários padrão)
...
-- 7. Criar função para buscar horários formatados
...
-- 5. Configure as variáveis de ambiente no projeto
-- ============================================
