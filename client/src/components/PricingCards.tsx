                      ...
                      return (
                        <div className="text-center space-y-1">
                          <div className="flex justify-center items-center gap-4">
                            <div className="text-center">
                              <p className="text-3xl md:text-2xl lg:text-3xl font-bold font-montserrat text-green-400">{prices.pix}</p>
                              <p className="text-sm md:text-xs text-green-300 uppercase tracking-wide">PIX</p>
                            </div>
                            <div className="text-gray-400 text-2xl md:text-xl">|</div>
                            <div className="text-center">
                              <p className="text-3xl md:text-2xl lg:text-3xl font-bold font-montserrat text-blue-400">{prices.card}</p>
                              <p className="text-sm md:text-xs text-blue-300 uppercase tracking-wide">Cartão</p>
                            </div>
                          </div>
                        </div>
                      );
